...
def extract_frames(video_file):
    ...
    frame_rate = 4  # Desired frame rate (1 frame every 0.5 seconds)
    frame_count = 0
...
if __name__ == "__main__":
    # video_file = r"/media/m2g/workdisk/workspace/GitHub/m2g_racing/dataset/record/1.webm"  # Replace with your video's name

    for i in range(1, 6):
        video_file = f"/media/m2g/workdisk/workspace/GitHub/m2g_racing/dataset/record/{i}.webm"
